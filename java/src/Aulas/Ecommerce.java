...
public class Ecommerce {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.print((sexo.equals("F")) ? "Cliente Sra. " + nome : "Aqui estão as formas de pagamento:");
			System.out.print((sexo.equals("M")) ? "Cliente Sr. " + nome + "Aqui estão as formas de pagamento:"
					: "Cliente Srx. " + nome + "Aqui estão as formas de pagamento:");
			System.out.println("\n\n### OPÇÕES DE PAGAMENTO ###");
